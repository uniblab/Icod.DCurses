...
set "PACKAGE_VERSION="
for /f "delims=" %%V in ('dotnet msbuild Icod.DCurses.csproj -nologo -getProperty:PackageVersion') do set "PACKAGE_VERSION=%%V"
...
set "PACKAGE_PATH=%ARTIFACT_DIR%\Icod.DCurses.%PACKAGE_VERSION%.nupkg"
set "SYMBOLS_PATH=%ARTIFACT_DIR%\Icod.DCurses.%PACKAGE_VERSION%.snupkg"
