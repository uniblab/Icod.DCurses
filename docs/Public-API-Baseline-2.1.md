# Icod.DCurses 2.1 Development Public API Baseline

**Development package identity:** `2.1.0-alpha.1`.\
**AssemblyVersion:** `2.0.0.0`.\
**Direct production dependency:** `Icod.Terminal 1.18.0`.\
**Target frameworks:** `net8.0`, `net9.0`, `net10.0`.\
**Status:** T2111 review candidate; stable-source closure belongs to T2112.
...
`Public-API-Fingerprint-2.1.json` is the machine-readable development authority, guarded by `PublicApiFingerprintTests`. Compared with the immutable 2.0 fingerprint (75 types, 559 lines), the 2.1 fingerprint adds 21 exported types and removes none. The full declared-member delta is reviewed under the T2111 gate; the 2.0 assembly identity and direct dependency remain unchanged.
