...
## 2.2.0 — Release candidate, unpublished
...
- Preserved the published 2.1 source surface additively, `AssemblyVersion` `2.0.0.0`, .NET 8/9/10 targets, and the sole direct `Icod.Terminal 1.18.0` production dependency. RC qualification and publication remain pending.
